...
"""paises = {"Guatemala": "Ciudad de Guatemala", "El Salvador": "San Salvador", "Honduras": "Tegucigalpa","Nicaragua": "Managua", "Costa Rica": "San Jose", "Panama": "Panama", "Argentina": "Buenos Aires", "Colombia": "Bogota", "Venezuela": "Caracas", "España": "Madrid"}

ingreso = input('Ingresa un pais: ')
letra = ingreso.capitalize() in paises

if letra == True:
    print(paises[ingreso.capitalize()])
else:
...
if ingreso in jugadores:
    print(jugadores[ingreso])
else:
    print('El numero no corresponde a un jugador')